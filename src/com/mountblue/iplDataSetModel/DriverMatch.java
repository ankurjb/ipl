...
public class DriverMatch {
    String id, season, city, date, team1, team2, toss_winner, toss_decision, result, dl_applied, winner, win_by_runs, win_by_wickets, player_of_match, venue, umpire1, umpire2, umpire3;

    public DriverMatch(String[] data) {
        setId(data[0]);
        setSeason(data[1]);
        setResult(data[8]);
        setWinner(data[10]);
